(function (app) {
    app.controller('orderDetailEditController', orderDetailEditController)
    orderDetailEditController.$inject = ['$scope', 'apiService', 'notificationService', '$state', '$stateParams','commonService']
    function orderDetailEditController($scope, apiService, notificationService, $state, $stateParams, commonService) {
        // Load combobox
        $scope.product = {

(function (app) {
    app.controller('orderDetailAddController', orderDetailAddController)
    orderDetailAddController.$inject = ['$scope', 'apiService', 'notificationService', '$state', 'commonService']
    function orderDetailAddController($scope, apiService, notificationService, $state, commonService) {
        // Load combobox
        $scope.product = {
